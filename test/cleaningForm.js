...
module.exports = {
    ...
    'Проверка формы Клининг': function(browser) {
        browser
            .click('button[data-id="field_786_MTAwNTMyNDU=_10053247"]')
            .click('div[class="dropdown-menu show"] > div > ul > li:nth-child(30) > a')
    ...
    'Переход к созданию заявки Клининг': function(browser) {
        ...
        browser
            .waitForElementVisible('body', 'Заголовок загружен')
            .assert.urlContains('https://lk-zabota.pravocard.ru/usluga-10141989/10051997/?is_parent=1')
            .assert.titleContains('Клининг', 'title ok')
            .assert.textContains("h2", "Клининг")
